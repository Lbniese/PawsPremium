...
namespace Paws.Core.Managers
{
    ...
    public static class ItemManager
    {
        ...
        private static readonly Stopwatch LossOfControlDelay = new Stopwatch();
        private static readonly int ClearLossOfControlInMilliseconds = 800;
        ...
        static ItemManager()
        {
            ...
            AllowedItemConditionTypes = AppDomain.CurrentDomain.GetAssemblies()
                ...
                .Where(
                    o =>
                        o.Namespace == "Paws.Core.Conditions" && Attribute.IsDefined(o, typeof (ItemConditionAttribute)))
                .OrderBy(o => o.Name)
                .ToList();
        }
        ...
        ///     TODO: This method needs a bit of testing and caressing. I've noticed instances where the trinket did not get used
        ///     in some situations.
        /// </summary>
        ...
        public static async Task<bool> ClearLossOfControlWithTrinkets()
        {
            ...
            {
                if (Me.HasLossOfControl() && !LossOfControlDelay.IsRunning)
                {
                    LossOfControlDelay.Start();
                    return false;
                }

                if (LossOfControlDelay.IsRunning)
                {
                    if (LossOfControlDelay.ElapsedMilliseconds > ClearLossOfControlInMilliseconds)
                    {
                        if (Me.Inventory.Equipped.Trinket1 != null)
                        {
                            if (Me.Inventory.Equipped.Trinket1.CooldownTimeLeft.TotalMilliseconds == 0)
                            {
                                ...
                                Log.Equipment(string.Format(
                                    "Clearing Loss of Control with Trinket #1: {0} after {1} ms",
                                    Me.Inventory.Equipped.Trinket1.SafeName, LossOfControlDelay.ElapsedMilliseconds));
                                await CommonCoroutines.SleepForLagDuration();
                            }
                            else
                            {
        ...
        public static async Task<bool> UseTrinket1()
        {
            ...
            if (SettingsManager.Instance.Trinket1Enabled)
            {
                if (target != null && trinket1 != null && trinket1.Usable &&
                    trinket1.CooldownTimeLeft.TotalMilliseconds == 0)
                {
                    // Use On Cooldown //
                    ...
                    else if (SettingsManager.Instance.Trinket1AdditionalConditions)
                    {
                        ...
                        if (SettingsManager.Instance.Trinket1HealthMinEnabled)
                            additionalConditionsSatisfied = target.HealthPercent <
                                                            SettingsManager.Instance.Trinket1HealthMin;
                        if (SettingsManager.Instance.Trinket1ManaMinEnabled)
                            additionalConditionsSatisfied = target.ManaPercent <
                                                            SettingsManager.Instance.Trinket1ManaMin;
        ...
        public static async Task<bool> UseTrinket2()
        {
            ...
            {
                if (target != null && trinket2 != null && trinket2.Usable &&
                    trinket2.CooldownTimeLeft.TotalMilliseconds == 0)
                {
                    // Use On Cooldown //
                    ...
                    {
                        var additionalConditionsSatisfied = false;
                        if (SettingsManager.Instance.Trinket2HealthMinEnabled)
                            additionalConditionsSatisfied = target.HealthPercent <
                                                            SettingsManager.Instance.Trinket2HealthMin;
                        if (SettingsManager.Instance.Trinket2ManaMinEnabled)
                            additionalConditionsSatisfied = target.ManaPercent <
                                                            SettingsManager.Instance.Trinket2ManaMin;
        ...
        public static void LoadDataSet()
        {
            ...
            var serializer = new XmlSerializer(typeof (List<PawsItem>));
        ...
        public static List<ItemCondition> GetAllowedItemConditions()
        {
            ...
            foreach (var conditionType in AllowedItemConditionTypes)
            {
