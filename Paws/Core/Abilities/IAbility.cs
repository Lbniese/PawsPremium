...
namespace Paws.Core.Abilities
{
    ...
    public interface IAbility
    {
        ...
        /// <summary>
        ///     Casts the ability's spell on the specified target. The cast will only be attempted if the conditions list is
        ///     completely satisfied first.
        /// </summary>
        /// <returns>Returns true on a successful cast.</returns>
        Task<bool> CastOnTarget(WoWUnit target);

        /// <summary>
        ///     Provides an opportunity to allow the ability to update based on dynamic information. This should be called during
        ///     Main.Pulse().
        /// </summary>
        void Update();
    }
